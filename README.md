...
| Landmarks | 5 models | Bethesda Terrace (sandstone arcade + grand staircases + balustrades), Belvedere Castle (octagonal tower + loggia wing + battlements), Swedish Cottage (Scandinavian log cabin + steep gable + entry porch), The Dairy (Victorian Gothic polychrome + open loggia + ridge cresting), 30 comfort stations (schist walls + gable roof + doorway surrounds) |
